...
Using the obtained propagation scores, we can create the final network and visualize it using a graphic interface. Remember that these functions require annotation.
