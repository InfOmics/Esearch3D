...
In order to use the GUI, it is necessary to provide a data frame with gene and fragment annotation. It has to be a 4-column data frame where the first column is the gene or fragment ID, the second is the chromosome, and the last two are start and end position.
...
The obtained propagation scores, which are stored in ff_prop and gd_prop, can be used to create the final network and visualize it using a graphic interface. Remember that these functions require annotation.
